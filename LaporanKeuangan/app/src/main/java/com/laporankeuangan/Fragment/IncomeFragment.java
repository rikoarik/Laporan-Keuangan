...
import com.laporankeuangan.ViewModel.IncomeViewModel;
...
public class IncomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        img = (ImageView) view.findViewById(R.id.imagein);
        btGaleri = view.findViewById(R.id.filein);
        btCamera = view.findViewById(R.id.camerain);
        mjumlah = (EditText) view.findViewById(R.id.saldoin);
        mnotes = (EditText) view.findViewById(R.id.notesaddin);
        tvDateResult = (TextView) view.findViewById(R.id.datein);
        btDatePicker = (ImageButton) view.findViewById(R.id.btdate);
        spinner = view.findViewById(R.id.kategoriin);

        ArrayAdapter adapter = ArrayAdapter.createFromResource(getContext(), R.array.kategoriincome, R.layout.spinner_layout_color);
    ...
    private void uploadImage() {
        ...
        if(imageUri  != null)
        {
            ...
            StorageReference ref = storageReference.child("images/income" + imageUri.getLastPathSegment());
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    incomeModel.setimgurl(url.toString());
                                    incomeModel.setKategori(spinner.getSelectedItem().toString());
                                    incomeModel.setTanggal(tvDateResult.getText().toString());
                                    incomeModel.setJumlah(Integer.parseInt(mjumlah.getText().toString()));
                                    incomeModel.setNotes(mnotes.getText().toString());
                                    viewModel.saveIncome(getActivity(), incomeModel);


                                }
                            });
                            progressDialog.dismiss();
                            Toast.makeText(getContext(), "Data Income Tersimpan", Toast.LENGTH_LONG).show();
                    ...
                    .addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onProgress(UploadTask.TaskSnapshot taskSnapshot) {
                            double progress = (100.0*taskSnapshot.getBytesTransferred()/taskSnapshot
                                    .getTotalByteCount());
                            progressDialog.setTitle("Save Your Income");
